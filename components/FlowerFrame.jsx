...
import DrawSVGPlugin from 'gsap/dist/DrawSVGPlugin'; // Import DrawSVGPlugin from gsap
import $ from 'jquery';
...
const FlowerFrame = () => {
    useEffect(() => {
        ...
        // Ensure that your animations start properly
        tl.play();
    }, []);
    ...
    return (
        <div className="container">
            ...
            {/* Your SVG code */}
            <svg id="flower-frame" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                {/* Your SVG content */}
            </svg>
            <style jsx>{`
        body {
